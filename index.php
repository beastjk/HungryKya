...
?>
    ...
    <div class="wide">
        ...
        <div class="col-xs-2 logo"><img src="images/hungrykya.png"></div>
        <div class="col-xs-5 line"><hr></div>
...
<!--
     ...
     <h1>Welcome to Hungry Kya?</h1>
    <p><br> 
      <h4>Remember last time when you had close guest from <font color="green"><strong></strong>, <strong>Kerala</strong>, <strong>Chennai</strong></font> announcing their surprise visit to your sweet home. Which is the follwed by sincere requests like let's have the <font color="green"><strong>famous biriyani of Chennai</strong>.</font> While someone is asking to eat Kallumakkaya Fry from <font color="green"><strong>Calicut in Kerala</strong>.</font> God they blurted as if the prime purpose was to taste the food than to see the well being of you. Well we know its not like they love to get pampered by you.
    </p>
    <p>
...
-->
    <div class="paragraph1">
     <h1>HUNGRY KYA? - Good Food is Good Mood</h1>
    <p><br> 
      <h4>
      Hungry Kya? will help in making your quest for enjoying good lunch, dinner which is are home delivered all the more interesting and excited when you are scartching your head to entertain your guest with their demands met.
      </h4>
    </p>
    <p>
      <h4>
        You can <font color="green"><strong>order food online</strong></font> with us through our user friendly website and get it home delivered. Or if you are busy in your schedule and just want to eat at leisure at home you can order takeaway from host of restaurants and pickup the food parcel kept ready for you while you are on the way to home.
      </h4>
    </p>
    </div>
    ...
    <div class="paragraph1">
          ...
          <p>
            <h4>
              Yes, Hungry Kya? is another way to live life with our loved ones...
            </h4>
          </p>
      </div>
  ...
  <br>
  <p> Hungry Kya? 2020 | &copy All Rights Reserved </p>
  <br>
  </footer>
</html>